...
function OrderDetails() {
  ...
  const orderIngredients = order?.ingredients.filter(function (item, position, array) {
    return array.lastIndexOf(item) === position // вернём уникальные элементы // вернём уникальные элементы
  })
